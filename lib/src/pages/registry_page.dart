...
import 'package:product_firebase/src/providers/user_provider.dart';
import 'package:product_firebase/src/utils/utils.dart';
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Camilo Verganzo', style: TextStyle( color: Colors.white, fontSize: 25.0 ),)
            ],
          ),
        )
      ],
